...
export const Header = () => {
  ...
  const isSolidHeader = isSubPage || isPastHero;
          ...
          <span className="flex flex-col leading-none">
            <span
              className={cn(
                ...
                isSolidHeader ? "text-zinc-950" : "text-white",
              )}
            >
              {LANDING_TEXT.logo}
            </span>
            <span
              className={cn(
                ...
                isSolidHeader ? "text-zinc-600" : "text-white/72",
              )}
            >
              {logoSubline}
            </span>
              ...
              {(() => {
                ...
                return resolvedHref.startsWith("#") ? (
                  <a
                    href={resolvedHref}
                    className={cn(
                      "text-sm font-semibold transition-colors duration-300 lg:text-base",
                      isActive
                        ? "text-[#0b78cf]"
                        : isSolidHeader
                          ? "text-black/75 hover:text-[#0b78cf]"
        ...
        <Sheet>
          <SheetTrigger
            className={cn(
              ...
              isSolidHeader ? "text-black border-black/25" : "text-white",
            )}
            aria-label="Mở menu"
          >
          ...
          <SheetContent
            side="right"
            className="w-[82%] border-l border-black/10 bg-white p-6"
          >
                ...
                return resolvedHref.startsWith("#") ? (
                  <a
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "text-[#0b78cf]"
                        : "text-black/80 hover:text-[#0b78cf]",
                    )}
                  >
                    {item.label}
                  </a>
